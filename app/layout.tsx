...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Bynomo — Trade over 300+ Crypto, Stocks, Metals and Forex on BNB Chain",
    description:
      "On-chain binary options trading dApp on BNB Chain. Powered by Pyth Hermes and Supabase. Oracle-bound resolution, minimal trust.",
    images: [{ url: '/bynomo-logo.png', width: 512, height: 512, alt: 'Bynomo' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: "Bynomo — Trade over 300+ Crypto, Stocks, Metals and Forex on BNB Chain",
    description: "On-chain binary options on BNB Chain. Oracle-bound resolution, minimal trust.",
