...
const CHAINS = [
    // `bg` is optional background override (kept for compatibility with existing UI logic)
    { name: 'BNB Chain', id: 'BNB', color: '#F3BA2F', logo: '/logos/bnb-bnb-logo.png', bg: '' },
];
...
export default function HowItWorksDemo() {
    ...
    const features = [
        {
            title: "BNB Chain Access",
            desc: "Connect instantly with MetaMask or Privy on BNB Chain. No bridging required.",
                ...
                <div className="bg-[#1A1A22] border border-white/10 rounded-2xl p-4 flex items-center gap-4 min-w-[300px]">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="text-2xl font-mono text-white font-bold flex items-center gap-2">
                            +1.95 <span className="text-purple-400 text-sm">BNB</span>
                        </div>
                    </div>
