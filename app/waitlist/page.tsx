...
const steps = [
    {
        ...
        desc: "BNB Chain performance with non-custodial security. Bynomo connects your wallet to a high-speed house balance for instant execution without gas lag."
    },
    {
        id: "02",
        title: "Multi-Asset Feed",
        desc: "Trade more than just crypto. Predict millisecond movements on Bitcoin, BNB, Gold, and Tech giants like NVDA and TSLA via Pyth Fixed Oracles."
    },
    {
        id: "03",
...
const faqs = [
    {
        ...
        answer: "To ensure millisecond execution, BYNOMO uses a hybrid house balance system. You deposit BNB on BNB Chain into a non-custodial treasury, which is then reflected in your game balance for instant off-chain betting."
    },
    {
        question: "What assets can I trade?",
        answer: "BYNOMO supports a wide range of assets including major cryptos (BTC, ETH, BNB), precious metals (Gold, Silver), and top-tier stocks (AAPL, NVDA, TSLA) through Pyth price feeds."
    },
    {
