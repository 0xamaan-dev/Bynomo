...
export const WalletConnect: React.FC = () => {
  ...
  const { network, address, setConnectModalOpen, disconnect: disconnectStore, setPreferredNetwork } = useBynomoStore();
  ...
  const handleDisconnect = () => {
    // For BNB-only, just log out Privy (if used) and clear store state
