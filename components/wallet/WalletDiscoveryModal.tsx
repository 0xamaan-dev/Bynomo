...
export const WalletDiscoveryModal: React.FC<WalletDiscoveryModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleBNBConnect = () => {
    ...
    onClose();
    setTimeout(() => setBNBVisible(true), 100);
  };
        ...
        <div className="relative space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            >
              ...
              <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-yellow-500/20 to-yellow-600/5 flex items-center justify-center border border-yellow-500/20">
              ...
              <svg className="w-5 h-5 text-yellow-500/50 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
